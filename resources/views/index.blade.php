...
<div class="text-center mt-10">
  ...
  <form action="{{route('saveTask')}}" method="POST" class="pt-10">
    ...
    <div class="flex flex-col w-80 m-auto">
      ...
      <input type="text" name="description" placeholder="Description" class="p-3 border-solid border-2 border-gray-200 rounded" autocomplete="off">
  ...
  <thead class="border-solid border-2 border-gray-200">
    <tr>
      ...
      <th class="border-solid border-2 border-gray-200 w-96 text-left p-2">Description</th>
  ...
  <tbody>
    ...
    @foreach($tasks as $task)
      <tr>
        ...
        <td class="border-solid border-2 border-gray-200 pt-5 pb-5 text-left p-2">{{ $task->description }}</td>
